...
import { open_create_conversation, updateMessage } from "../../../features/chatSlice";
import {
  getConversationId,
  getConversationName,
...
function Conversation({ convo, socket, online, typing }) {
  ...
  const isSender = _id === convo.latestMessage?.sender?._id;
  let showIcon = convo.latestMessage?.isRead;
  if (isSender) {
    showIcon = true;
  }
  const openConversation = async () => {
    ...
    dispatch(updateMessage(valuess));  
            ...
            <div>
              <div className="flex items-center gap-x-1 dark:text-dark_text_2">
                ...
                {typing === convo._id ? (
                  ...
                  showIcon === false ? (
                    <p style={{ fontWeight: 'bold' }} className="dark:text-dark_text_1">
